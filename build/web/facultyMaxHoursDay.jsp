    ...
    <head>
        ...
        <script>
            ...
            function deleteContent(faculty_maxhours_day_id)
            {
                ...
                document.faculty_maxhours_dayForm.action = "${pageContext.request.contextPath}/TableDeleteController";
            ...
            function updateContent(faculty_maxhours_day_id)
            {
                ...
                document.faculty_maxhours_dayForm.action = "${pageContext.request.contextPath}/TableUpdateController/faculty_maxhours_day";
                document.faculty_maxhours_dayForm.submit();
            }
        </script>
    </head>
    <body>
        <form methd="post" name="faculty_maxhours_dayForm" action="${pageContext.request.contextPath}/TableInsertController/faculty_maxhours_day" ondblclick="return validateData">
