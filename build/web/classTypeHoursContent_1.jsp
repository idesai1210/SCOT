    ...
    <head>
        ...
        <script>
            ...
            function deleteContent(class_type_hours_id)
            {
                ...
                document.class_type_hoursForm.action = "${pageContext.request.contextPath}/UserTableDeleteController";
            ...
            function updateContent(class_type_hours_id)
            {
                ...
                document.class_type_hoursForm.action = "${pageContext.request.contextPath}/UserTableUpdateController/class_type_hours";
                document.class_type_hoursForm.submit();
            }
        </script>
    </head>
    <body>
        <form methd="post" name="class_type_hoursForm" action="${pageContext.request.contextPath}/UserTableInsertController/class_type_hours" ondblclick="return validateData">
