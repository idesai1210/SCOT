    ...
    <head>
        ...
        <script>
            ...
            function deleteContent(subject_continuous_id)
            {
                ...
                document.subject_continuousForm.action = "${pageContext.request.contextPath}/TableDeleteController";
            ...
            function updateContent(subject_continuous_id)
            {
                ...
                document.subject_continuousForm.action = "${pageContext.request.contextPath}/TableUpdateController/subject_continuous";
                document.subject_continuousForm.submit();
            }
        </script>
    </head>
    <body>
        <form methd="post" name="subject_continuousForm" action="${pageContext.request.contextPath}/TableInsertController/subject_continuous" ondblclick="return validateData">
