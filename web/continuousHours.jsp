    ...
    <head>
        ...
        <script>
            ...
            function deleteContent(continuous_hours_id)
            {
                ...
                document.continuous_hoursForm.action = "${pageContext.request.contextPath}/TableDeleteController";
            ...
            function updateContent(continuous_hours_id)
            {
                ...
                document.continuous_hoursForm.action = "${pageContext.request.contextPath}/TableUpdateController/continuous_hours";
                document.continuous_hoursForm.submit();
            }
        </script>
    </head>
    <body>
        <form methd="post" name="continuous_hoursForm" action="${pageContext.request.contextPath}/TableInsertController/continuous_hours" ondblclick="return validateData">
