...
<html>
    <head>
        ...
        <script>
            ...
            function deleteContent(institute_id)
            {
                ...
                document.instituteDetailForm.action = "${pageContext.request.contextPath}/UserTableDeleteController";
            ...
            function updateContent(institute_id)
            {
                ...
                document.instituteDetailForm.action = "${pageContext.request.contextPath}/UserTableUpdateController/instituteDetail";
                document.instituteDetailForm.submit();
            }
        </script>
    ...
    <body>   
        <form name="instituteDetailForm" method="post" action="${pageContext.request.contextPath}/UserTableInsertController/institute_detail" onsubmit="return validateData()">
