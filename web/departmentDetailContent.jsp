    ...
    <head>
        ...
        <script>
            ...
            function deleteContent(department_id)
            {
                ...
                document.departmentDetailForm.action = "${pageContext.request.contextPath}/TableDeleteController";
            ...
            function updateContent(department_id)
            {
                ...
                document.departmentDetailForm.action = "${pageContext.request.contextPath}/TableUpdateController/departmentDetail";
                document.departmentDetailForm.submit();
            }
            function dataGet()
            {
                window.location.assign("${pageContext.request.contextPath}" + "/TableController/department_detail");
            }
        </script>
